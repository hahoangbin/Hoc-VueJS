<template>
  <div class="wrapper-player">
    <div class="player-panel" :class="{ active: activePlayer == 0 && !this.isWinner, winner: activePlayer == 0 && this.isWinner }">
    ...
    <div class="player-panel" :class="{ active: activePlayer == 1 && !this.isWinner, winner: activePlayer == 1 && this.isWinner }">
...
export default {
  ...
  props: {
    ...
    curentScore: {type: Number, default: 0},
